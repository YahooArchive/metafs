...
METADATA_FILENAME = 'metafs/package_metadata.json'
...
setup_arguments = {
    ...
    'url': 'http://github.com/yahoo/metafs',
    'license': 'LICENSE.txt',
    'packages': ['metafs'],
    'long_description': 'MetaFS is for generating a datastore of file metadata for rapid complex searches',
    'description': 'MetaFS is for generating a datastore of file metadata for rapid complex searches',
    'classifiers': [
